          ...
          switch (((p = !0), n.settings.effect)) {
            case "typography":
              l.find("li").hide(),
                ...
                l.find("li").eq(b).animate({ width: "100%", opacity: 1 }, 1500);
              break;
            case "fade":
              ...
              m <= 1
                ? l
                    ...
                    .animate({ top: 30, opacity: 0 }, 300, function () {
                      t(this).css({ top: -30, opacity: 0, display: "block" }),
                        t(this).animate({ top: 0, opacity: 1 }, 300);
                    })
                : (l
                    .find("li:visible")
                    .animate({ top: 30, opacity: 0 }, 300, function () {
              ...
              m <= 1
                ? l
                    ...
                    .animate({ left: "50%", opacity: 0 }, 300, function () {
                      t(this).css({ left: -50, opacity: 0, display: "block" }),
                        t(this).animate({ left: 0, opacity: 1 }, 300);
                    })
                : (l
                    .find("li:visible")
                    .animate({ left: "50%", opacity: 0 }, 300, function () {
      ...
      (n.init = function () {
        if (
          ...
          "fixed-top" === n.settings.position
            ? r.addClass("bn-fixed-top").css({ "z-index": n.settings.zIndex })
            : "fixed-bottom" === n.settings.position &&
              r
                .addClass("bn-fixed-bottom")
                .css({ "z-index": n.settings.zIndex }),
          "default" != n.settings.fontSize &&
            r.css({ "font-size": n.settings.fontSize }),
          "default" != n.settings.themeColor &&
            (r.css({
              "border-color": n.settings.themeColor,
              color: n.settings.themeColor,
            }),
            o.css({ background: n.settings.themeColor })),
          "default" != n.settings.background &&
            r.css({ background: n.settings.background }),
          r.css({
          ...
          c
            .find(".bn-seperator")
            .css({ height: n.settings.height - 2 * n.settings.borderWidth }),
          r.addClass(
            "bn-effect-" +
              n.settings.effect +
              " bn-direction-" +
